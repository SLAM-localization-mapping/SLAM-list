...
| ------------  | -------- | --- | --- | --- | --- |
| [MonoSLAM](https://github.com/hanmekim/SceneLib2) | mono | https://github.com/hanmekim/SceneLib2 |  | | | |
| [PTAM](https://www.robots.ox.ac.uk/~gk/PTAM) | mono | https://www.robots.ox.ac.uk/~gk/PTAM |  |  | |
| [ORB-SLAM](http://webdiis.unizar.es/~raulmur/orbslam) | mono为主 | http://webdiis.unizar.es/~raulmur/orbslam | C++ | GPLv3 | |
| [LSD-SLAM](http://vision.in.tum.de/research/vslam/lsdslam) | mono为主 | http://vision.in.tum.de/research/vslam/lsdslam | C++/ROS | GNU General Public License | |
| [SVO](https://github.com/uzh-rpg/rpg_svo) | mono | https://github.com/uzh-rpg/rpg_svo | C++/ROS | GNU General Public License | |
...
| [DSO](https://github.com/JakobEngel/dso) | mono | https://github.com/JakobEngel/dso | | | |
| [RTAB-MAP](https://github.com/introlab/rtabmap) | Stereo/RGB-D | https://github.com/introlab/rtabmap | | | |
...
| [OKVIS](https://github.com/ethz-asl/okvis) | multi-mono+IMU | https://github.com/ethz-asl/okvis | | | |
| [ROVIO](https://github.com/ethz-asl/rovio) | multi-mono+IMU | https://github.com/ethz-asl/rovio | | | |
